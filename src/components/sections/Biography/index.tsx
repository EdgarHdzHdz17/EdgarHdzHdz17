...
const Biography: React.FC = () => {
  return (
    <section className="relative overflow-hidden border-b border-slate-200/60 bg-gradient-to-b from-white via-slate-50/80 to-slate-50">
      <div
      ...
      <div className="section-shell relative flex flex-col items-center gap-10 pb-20 pt-12 md:flex-row md:items-start md:gap-14 md:pt-16">
        <div className="relative shrink-0">
          <div className="absolute -inset-1 rounded-full bg-gradient-to-br from-blue-500/20 via-slate-200 to-indigo-500/20 blur-sm" />
          <div className="relative h-40 w-40 overflow-hidden rounded-full border-4 border-white shadow-card ring-1 ring-slate-200/80 sm:h-44 sm:w-44">
            <img
              src={Profile}
              width={176}
              height={176}
