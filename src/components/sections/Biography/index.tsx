  ...
  return (
    <>
      <section className="w-full p-5 flex justify-center items-center">
        <div className="flex flex-col md:flex-row items-center md:items-center gap-8 px-60 max-sm:px-2 mt-10 max-sm:gap-2">
          ...
          <div className="flex flex-col gap-5 max-sm:gap-2">
            ...
            <p className="text-lg mb-4 text-center max-sm:text-justify max-sm:text-sm">
